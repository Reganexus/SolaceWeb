...
export default function DownloadGallery() {
    ...
    return (
        <section
            className="relative text-black h-max py-24"
        >
            <div className="container mx-auto py-24 px-4">
                <h2 className="text-4xl font-bold text-center mb-12 text-black">Main Features</h2>
                    ...
                    {features.map((feature, index) => (
                        ...
                        >
                            ...
                            <div className="flex-1 lg:text-start text-center ">
                                <h3 className="lg:text-3xl text-2xl font-bold mb-4 text-black">{feature.title}</h3>
                                <p className="lg:text-xl text-base text-justify leading-relaxed text-neutral-700">
                                    {feature.description}
                                </p>
                            </div>
                        </div>
