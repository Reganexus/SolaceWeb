...
export default function Navbar() {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ease-in-out py-3 ${
      ...
      <div className="container mx-auto flex items-center justify-between flex-wrap px-4">
        ...
        <div className="block lg:hidden">
          <button
            ...
            className={`flex items-center px-3 py-2 ${
              isScrolled ? "text-black" : isOpen ? "text-black" : "text-white"
            }`}
          >
        ...
        <div
          className={`absolute top-full left-0 w-full transition-all duration-500 ease-in-out ${
            isOpen ? "bg-white opacity-100 max-h-[500px]" : "bg-transparent opacity-0 max-h-0"
          } lg:static lg:bg-transparent lg:opacity-100 lg:max-h-none lg:flex lg:items-center lg:w-auto`}
        >
          <div
            className={`flex flex-col lg:flex-row ${
              isOpen ? "justify-start items-start pl-6 py-4" : "justify-center items-center"
            } space-y-4 lg:space-y-0 lg:space-x-8 w-full`}
          >
            <a
              href="#about"
